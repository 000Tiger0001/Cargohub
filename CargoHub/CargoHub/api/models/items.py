...
class Items(Base):
    ...
    def get_item(self, item_id) -> dict or None:  # type: ignore
        for x in self.data:
            if x["uid"] == item_id:
                return x
        return None

    def get_items_for_item_line(self, item_line_id) -> list:
        result = []
        for x in self.data:
    ...
    def get_items_for_item_group(self, item_group_id) -> list:
        result = []
        for x in self.data:
    ...
    def get_items_for_item_type(self, item_type_id) -> list:
        result = []
        for x in self.data:
    ...
    def get_items_for_supplier(self, supplier_id) -> list:
        result = []
        for x in self.data:
    ...
    def update_item(self, item_id, item) -> None:
        item["updated_at"] = self.get_timestamp()
