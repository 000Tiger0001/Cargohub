public class ShipmentItemMovementServices
{
    ...
    public async Task<bool> AddShipmentItemMovement(ShipmentItemMovement shipmentItemMovement)
    {
        ...
        if (shipmentItemMovements.FirstOrDefault(s => s.Id == shipmentItemMovement.Id || (s.Amount == shipmentItemMovement.Amount && s.ItemId == shipmentItemMovement.ItemId)) is not null) return false;
