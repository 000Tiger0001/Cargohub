public class OrderItemMovementServices
{
    ...
    public async Task<bool> AddOrderItemMovement(OrderItemMovement orderItemMovement)
    {
        ...
        OrderItemMovement doubleOrderItemMovement = orderItemMovements.FirstOrDefault(o => o.Id == orderItemMovement.Id || (o.ItemId == orderItemMovement.ItemId && o.Amount == orderItemMovement.Amount))!;
        if (doubleOrderItemMovement is not null) return false;
