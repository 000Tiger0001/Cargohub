public class TransferItemMovementServices
{
    ...
    public async Task<bool> AddTransferItemMovement(TransferItemMovement transferItemMovement)
    {
        ...
        if (transferItemMovements.FirstOrDefault(t => t.Id == transferItemMovement.Id || (t.ItemId == transferItemMovement.ItemId && t.Amount == transferItemMovement.Amount)) is not null) return false;
