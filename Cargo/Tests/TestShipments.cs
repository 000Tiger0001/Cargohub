...
public class ShipmentTests
{
    ...
    public async Task GetAllShipments()
    {
        ...
        Order testOrder = new(1, 1, DateTime.Now, DateTime.Now, "123", "1", "Pending", "To deliver", "Be carefull", "Don't trow", 1, 1, 1, 1, 12, 12, 12, 12, [orderItemMovement]);
    ...
    public async Task AddShipmentWithDuplicateId()
    {
        ...
        Item item1 = new(7435, "hdaffhhds1", "random1", "r1", "5555 EE1", "hoie1", "jooh1", 11, 73, 14, 100, 100, 100, 1, "0000", "0000");
        Item item2 = new(9557, "hdaffhhds2", "random2", "r2", "5555 EE2", "hoie2", "jooh2", 11, 73, 14, 100, 100, 100, 1, "0000", "0000");
        Order testOrder1 = new(1, 1, DateTime.Now, DateTime.Now, "123", "1", "Pending", "To deliver", "Be carefull", "Don't trow", 1, 1, 1, 1, 12, 12, 12, 12, [orderItemMovement]);
        Order testOrder2 = new(2, 1, DateTime.Now, DateTime.Now, "456", "4", "Pending", "To deliver", "Don't be carefull", "Trow", 1, 1, 1, 1, 12, 12, 12, 12, [mockItem2]);
